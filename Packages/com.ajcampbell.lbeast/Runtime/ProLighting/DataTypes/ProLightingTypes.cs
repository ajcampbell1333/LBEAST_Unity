...
namespace LBEAST.ProLighting
{
    ...
    public enum LBEASTDMXFixtureType : byte
    {
        Dimmable = 0,
        RGB = 1,
        RGBW = 2,
    ...
    public enum LBEASTDMXMode : byte
    {
        USBDMX = 0,
        ArtNet = 1,
        SACN = 2
    ...
    public class LBEASTDMXFixture
    {
        ...
        public LBEASTDMXFixtureType FixtureType = LBEASTDMXFixtureType.Dimmable;
    ...
    [Serializable]
    public class LBEASTProLightingConfig
    {
        [Tooltip("Communication mode (USB DMX or Art-Net)")]
        public LBEASTDMXMode DMXMode = LBEASTDMXMode.USBDMX;
    ...
    [Serializable]
    public class LBEASTDiscoveredFixture
    {
