...
namespace LBEAST.ProLighting
{
    ...
    {
        void ApplyIntensity(LBEASTDMXFixture fixture, float intensity, UniverseBuffer buffer);
        void ApplyColor(LBEASTDMXFixture fixture, float red, float green, float blue, float white, UniverseBuffer buffer);
    }

    /// <summary>Dimmable fixture driver (1 channel - intensity only)</summary>
    public class FixtureDriverDimmable : IFixtureDriver
    {
        public void ApplyIntensity(LBEASTDMXFixture fixture, float intensity, UniverseBuffer buffer)
        {
            var v = (byte)(Mathf.Clamp01(intensity) * 255f);
            buffer.SetChannel(fixture.Universe, fixture.DMXChannel, v);
        }

        public void ApplyColor(LBEASTDMXFixture fixture, float red, float green, float blue, float white, UniverseBuffer buffer) { }
    }
