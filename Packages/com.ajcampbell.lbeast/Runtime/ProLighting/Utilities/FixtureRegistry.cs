...
namespace LBEAST.ProLighting
{
    ...
    {
        private readonly Dictionary<int, LBEASTDMXFixture> fixtures = new Dictionary<int, LBEASTDMXFixture>();
        ...
        public bool Register(LBEASTDMXFixture fixture)
        {
        ...
        public LBEASTDMXFixture Find(int virtualFixtureID) => fixtures.TryGetValue(virtualFixtureID, out var fixture) ? fixture : null;

        public LBEASTDMXFixture FindMutable(int virtualFixtureID) => Find(virtualFixtureID); // In C#, classes are reference types, so Find works for mutable access
