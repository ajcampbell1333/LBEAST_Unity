...
namespace LBEAST.ProLighting
{
    ...
    public class FixtureService
    {
        ...
        public bool ValidateAndRegister(LBEASTDMXFixture fixture)
        {
            ...
            var valid = new LBEASTDMXFixture
            {
                VirtualFixtureID = fixture.VirtualFixtureID,
                FixtureType = fixture.FixtureType,
                DMXChannel = fixture.DMXChannel,
                Universe = fixture.Universe,
                ChannelCount = fixture.ChannelCount > 0 ? fixture.ChannelCount : (fixture.FixtureType == LBEASTDMXFixtureType.Custom
                    ? Mathf.Max(1, fixture.CustomChannelMapping?.Count ?? 0)
                    : (fixture.FixtureType == LBEASTDMXFixtureType.Dimmable ? 1
                        : (fixture.FixtureType == LBEASTDMXFixtureType.RGB ? 3
                            : (fixture.FixtureType == LBEASTDMXFixtureType.RGBW ? 4 : 8)))),
        ...
        public void ApplyIntensity(LBEASTDMXFixture fixture, float intensity)
        {
            var driver = FixtureDriverFactory.Create(fixture.FixtureType);
            driver.ApplyIntensity(fixture, intensity, buffer);
        }

        public void ApplyColor(LBEASTDMXFixture fixture, float red, float green, float blue, float white)
        {
            var driver = FixtureDriverFactory.Create(fixture.FixtureType);
            driver.ApplyColor(fixture, red, green, blue, white, buffer);
        }

        public void ApplyChannelRaw(LBEASTDMXFixture fixture, int channelOffset, byte value)
        {
        ...
        public int SetColorRGBWById(int virtualFixtureID, float red, float green, float blue, float white)
        {
            ...
            {
                case LBEASTDMXFixtureType.RGB:
                case LBEASTDMXFixtureType.RGBW:
                case LBEASTDMXFixtureType.MovingHead:
                case LBEASTDMXFixtureType.Custom:
                    break;
                default:
        ...
        public LBEASTDMXFixture FindFixture(int virtualFixtureID) => registry.Find(virtualFixtureID);

        public LBEASTDMXFixture FindFixtureMutable(int virtualFixtureID) => registry.FindMutable(virtualFixtureID);
