...
namespace LBEAST.ProLighting
{
    ...
    {
        public static TransportSetupResult CreateTransport(LBEASTProLightingConfig config)
        {
            var result = new TransportSetupResult();
            switch (config.DMXMode)
            {
                case LBEASTDMXMode.USBDMX:
