...
{
    /// <summary>
    /// Universal input adapter for LBEAST experiences.
    ...
    /// </summary>
    public class LBEASTInputAdapter : NetworkBehaviour
    {
        // ========================================
        // CONFIGURATION
        // ========================================
        ...
        public void InjectButtonPress(int buttonIndex)
        {
            ...
            {
                Debug.LogWarning($"[LBEASTInputAdapter] Invalid button index {buttonIndex} (must be 0-{buttonCount - 1})");
                return;
            }
        ...
        public void InjectAxisValue(int axisIndex, float value)
        {
            ...
            {
                Debug.LogWarning($"[LBEASTInputAdapter] Invalid axis index {axisIndex} (must be 0-{axisCount - 1})");
                return;
            }
