...
namespace LBEAST.Core.Networking
{
    ...
    /// 
    /// Used by:
    /// - LBEASTUDPTransport (adds LBEAST binary protocol)
    ...
    public class UDPTransportBase
    {
        ...
        public bool InitializeUDPConnection(string remoteIP, int remotePort, string socketName = "LBEAST_UDP", bool enableBroadcast = false)
        {
            try
            {
                // Parse IP address
