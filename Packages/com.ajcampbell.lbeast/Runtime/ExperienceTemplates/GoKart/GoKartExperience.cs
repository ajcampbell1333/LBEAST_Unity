...
using UnityEngine;
using LBEAST.Core;
using LBEAST.ExperienceTemplates.GoKart.Models;
using System.Collections.Generic;

namespace LBEAST.ExperienceTemplates.GoKart
{
    /// <summary>
    ...
    /// </summary>
    public class GoKartExperience : LBEASTExperienceBase
    {
        [Header("Components")]
        ...
        protected override bool InitializeExperienceImpl()
        {
            ...
            if (ecuController != null)
            {
                ...
                {
                    Debug.LogError("[LBEAST] GoKartExperience: Failed to initialize ECU");
                    return false;
                }
            }
            ...
            Debug.Log("[LBEAST] GoKartExperience: Initialized");
            return true;
        }
        ...
        public bool SwitchTrack(int trackIndex)
        {
            ...
            {
                Debug.LogWarning($"[LBEAST] GoKartExperience: Invalid track index {trackIndex}");
                return false;
            }
            ...
            Debug.Log($"[LBEAST] GoKartExperience: Switched to track {trackIndex}");
            return true;
        }
