...
namespace LBEAST.ExperienceTemplates
{
    ...
    /// </summary>
    public class MovingPlatformExperience : LBEASTExperienceBase
    {
        ...
        protected override bool InitializeExperienceImpl()
        {
            if (platformController == null)
            {
                Debug.LogError("[LBEAST] MovingPlatformExperience: Platform controller is null");
                return false;
            }
            ...
            {
                Debug.LogError("[LBEAST] MovingPlatformExperience: Failed to initialize platform");
                return false;
            }

            Debug.Log("[LBEAST] MovingPlatformExperience initialized successfully");
            return true;
        }
