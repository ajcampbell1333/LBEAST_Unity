...
using LBEAST.ExperienceTemplates.SuperheroFlight.Models;

namespace LBEAST.ExperienceTemplates.SuperheroFlight
{
    /// <summary>
    ...
    /// </summary>
    public class SuperheroFlightExperience : LBEASTExperienceBase
    {
        ...
        protected override bool InitializeExperienceImpl()
        {
            ...
            {
                Debug.LogError("[LBEAST] SuperheroFlightExperience: Failed to initialize ECU");
                return false;
            }
            ...
            {
                Debug.LogError("[LBEAST] SuperheroFlightExperience: Failed to initialize flight hands controller");
                return false;
            }
            ...
            {
                Debug.LogError("[LBEAST] SuperheroFlightExperience: Failed to initialize gesture debugger");
                return false;
            }
            ...
            if (RF433MHzReceiver != null)
            {
                ...
                if (RF433MHzReceiver.InitializeReceiver(rfConfig))
                {
                    ...
                    Debug.Log("[LBEAST] SuperheroFlightExperience: RF433MHz receiver initialized");
                }
                else
                {
                    Debug.LogWarning("[LBEAST] SuperheroFlightExperience: Failed to initialize RF433MHz receiver - height calibration will be unavailable");
                }
            }
            ...
            Debug.Log("[LBEAST] SuperheroFlightExperience: Initialized");
            return true;
        }
        ...
        void Update()
        {
            ...
            if (!playSessionActive)
            {
                ...
                {
                    Debug.LogWarning("[LBEAST] SuperheroFlightExperience: Calibration timeout - disabling calibration mode");
                    ...
                    if (RF433MHzReceiver != null && RF433MHzReceiver.IsConnected())
                    {
                        ...
                        Debug.Log("[LBEAST] SuperheroFlightExperience: Calibration mode disabled due to timeout");
                    }
                }
            }
            else
        ...
        public void AcknowledgeStandingGroundHeight()
        {
            ...
            if (ECUController.GetDualWinchState(out SuperheroFlightDualWinchState winchState))
            {
                ...
                Debug.Log($"[LBEAST] SuperheroFlightExperience: Acknowledged standing ground height: {standingGroundHeight:F2} inches");
            }
        }
        ...
        private void TransitionToGameState(SuperheroFlightGameState newState)
        {
            ...
            Debug.Log($"[LBEAST] SuperheroFlightExperience: Transitioned to state {(int)newState}");
        }
        ...
        private bool CheckCalibrationSafetyInterlocks(string functionName)
        {
            ...
            if (playSessionActive)
            {
                Debug.LogWarning("[LBEAST] SuperheroFlightExperience: Calibration disabled - play session active");
                return false;
            }
            ...
            if (emergencyStop)
            {
                Debug.LogWarning("[LBEAST] SuperheroFlightExperience: Calibration disabled - emergency stop active");
                return false;
            }
            ...
            if (calibrationInactiveTime > CalibrationTimeout)
            {
                Debug.LogWarning("[LBEAST] SuperheroFlightExperience: Calibration disabled - timeout");
                return false;
            }
