...
namespace LBEAST.ExperienceTemplates
{
    ...
    public class FlightSimExperience : LBEASTExperienceBase
    {
        ...
        protected override bool InitializeExperienceImpl()
        {
            if (gyroscopeController == null)
            {
                Debug.LogError("[LBEAST] FlightSimExperience: Gyroscope controller is null");
                return false;
            }
            ...
            {
                Debug.LogError("[LBEAST] FlightSimExperience: Failed to initialize gyroscope controller");
                return false;
            }
            ...
            {
                Debug.Log("[LBEAST] FlightSimExperience: HOTAS connected successfully");
            }
            else
            {
                Debug.LogWarning("[LBEAST] FlightSimExperience: HOTAS not connected, using standard VR controllers");
            }

            Debug.Log("[LBEAST] FlightSimExperience initialized successfully");
            return true;
        }
