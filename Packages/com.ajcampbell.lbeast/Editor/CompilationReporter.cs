...
namespace LBEAST.Editor
{
    ...
    public static class CompilationReporter
    {
        ...
        private static void OnCompilationStarted(object obj)
        {
            ...
            errorLog.Clear();
            errorLog.AppendLine("===========================================");
            errorLog.AppendLine("LBEAST COMPILATION REPORT");
            ...
            errorLog.AppendLine($"Report ID: LBEAST-{System.Guid.NewGuid().ToString().Substring(0, 8).ToUpper()}");
            errorLog.AppendLine();
        }
        ...
        private static void OnCompilationFinished(object obj)
        {
            ...
            {
                Debug.LogError($"[LBEAST] Failed to write compilation report: {ex.Message}");
            }
        }
        ...
        /// </summary>
        [MenuItem("LBEAST/Compile and Report Errors")]
        public static void ManualCompileAndReport()
        {
            Debug.Log("[LBEAST] Manual compilation triggered...");
        ...
        /// </summary>
        [MenuItem("LBEAST/Open Compilation Report")]
        public static void OpenCompilationReport()
        {
            ...
            else
            {
                EditorUtility.DisplayDialog("Compilation Report", 
                    "No compilation report found. Try compiling first (LBEAST > Compile and Report Errors).", 
                    "OK");
            }
        }
        ...
        private static void GenerateCurrentReport()
        {
            ...
            report.AppendLine("===========================================");
            report.AppendLine("LBEAST COMPILATION REPORT (BATCH MODE)");
            report.AppendLine("===========================================");
            ...
            {
                Debug.LogError($"[LBEAST] Failed to write batch report: {ex.Message}");
            }
        }
    }
}
