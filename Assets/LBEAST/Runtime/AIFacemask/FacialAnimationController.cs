...
namespace LBEAST.AIFacemask
{
    ...
    public class FacialAnimationController : MonoBehaviour
    {
        ...
        public bool Initialize()
        {
            ...
            if (faceMeshRenderer == null)
            {
                Debug.LogError("[LBEAST] FacialAnimationController: No SkinnedMeshRenderer assigned");
                return false;
            }
            ...
            isInitialized = true;
            Debug.Log($"[LBEAST] Facial animation initialized with {blendShapeIndices.Count} blend shapes");
            return true;
        }
        ...
        private void CacheBlendShapeIndices()
        {
            ...
            if (mesh == null)
            {
                Debug.LogWarning("[LBEAST] No mesh found on SkinnedMeshRenderer");
                return;
            }
        ...
        public void StartAnimation()
        {
            ...
            isPlaying = true;
            Debug.Log($"[LBEAST] Started facial animation in {animationMode} mode");
        }
        ...
        public void StopAnimation()
        {
            ...
            Debug.Log("[LBEAST] Stopped facial animation");
        }
        ...
        public void StartPlayback()
        {
            ...
            {
                Debug.LogWarning("[LBEAST] No recorded frames to play");
                return;
            }
        ...
        public void LoadRecording(List<FacialAnimationFrame> frames)
        {
            ...
            Debug.Log($"[LBEAST] Loaded {frames.Count} animation frames");
        }
        ...
        public void StartRecording()
        {
            ...
            playbackTime = 0f;
            Debug.Log("[LBEAST] Started recording facial animation");
        }
        ...
        {
            Debug.Log($"[LBEAST] Stopped recording: {recordedFrames.Count} frames captured");
        ...
        public void SetBlendShapeWeight(string blendShapeName, float weight)
        {
            ...
            {
                Debug.LogWarning($"[LBEAST] Blend shape '{blendShapeName}' not found");
            }
        }
