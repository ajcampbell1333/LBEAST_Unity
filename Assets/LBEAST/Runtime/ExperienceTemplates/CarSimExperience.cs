...
namespace LBEAST.ExperienceTemplates
{
    ...
    /// </summary>
    public class CarSimExperience : LBEASTExperienceBase
    {
        ...
        protected override bool InitializeExperienceImpl()
        {
            if (platformController == null)
            {
                Debug.LogError("[LBEAST] CarSimExperience: Platform controller is null");
                return false;
            }
            ...
            {
                Debug.LogError("[LBEAST] CarSimExperience: Failed to initialize platform");
                return false;
            }

            Debug.Log("[LBEAST] CarSimExperience initialized successfully");
            return true;
        }
