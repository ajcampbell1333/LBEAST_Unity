...
namespace LBEAST.Core
{
    ...
    public class ExperienceStateMachine : MonoBehaviour
    {
        ...
        public void Initialize(List<ExperienceState> newStates)
        {
            ...
            if (states.Count > 0)
            {
                Debug.Log($"[LBEAST] ExperienceStateMachine: Initialized with {states.Count} states");
            }
            else
            {
                Debug.LogWarning("[LBEAST] ExperienceStateMachine: Initialized with no states");
            }
        }
        ...
        public void StartExperience()
        {
            if (states.Count == 0)
            {
                Debug.LogError("[LBEAST] ExperienceStateMachine: Cannot start - no states defined");
                return;
            }
            ...
            Debug.Log($"[LBEAST] ExperienceStateMachine: Started at state '{initialState}'");
        ...
        public bool AdvanceState()
        {
            if (!isRunning)
            {
                Debug.LogWarning("[LBEAST] ExperienceStateMachine: Cannot advance - experience not running");
                return false;
            }

            if (!CanAdvance())
            {
                Debug.LogWarning("[LBEAST] ExperienceStateMachine: Cannot advance from current state");
                return false;
            }
            ...
            Debug.Log($"[LBEAST] ExperienceStateMachine: Advanced from '{oldState}' to '{newState}' (Index {currentStateIndex})");
        ...
        public bool RetreatState()
        {
            if (!isRunning)
            {
                Debug.LogWarning("[LBEAST] ExperienceStateMachine: Cannot retreat - experience not running");
                return false;
            }

            if (!CanRetreat())
            {
                Debug.LogWarning("[LBEAST] ExperienceStateMachine: Cannot retreat from current state");
                return false;
            }
            ...
            Debug.Log($"[LBEAST] ExperienceStateMachine: Retreated from '{oldState}' to '{newState}' (Index {currentStateIndex})");
        ...
        public bool JumpToState(string stateName)
        {
            ...
            Debug.LogWarning($"[LBEAST] ExperienceStateMachine: State '{stateName}' not found");
            return false;
        }
        ...
        public bool JumpToStateIndex(int stateIndex)
        {
            ...
            {
                Debug.LogError($"[LBEAST] ExperienceStateMachine: Invalid state index {stateIndex}");
                return false;
            }
            ...
            Debug.Log($"[LBEAST] ExperienceStateMachine: Jumped from '{oldState}' to '{newState}' (Index {currentStateIndex})");
        ...
        public void ResetExperience()
        {
            ...
            Debug.Log($"[LBEAST] ExperienceStateMachine: Reset to initial state '{newState}'");
        ...
        {
            isRunning = false;
            Debug.Log($"[LBEAST] ExperienceStateMachine: Experience stopped at state '{GetCurrentStateName()}'");
        }
