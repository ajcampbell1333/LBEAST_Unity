@echo off
REM LBEAST Version Release Script
...
powershell -NoProfile -Command "$content = Get-Content 'Packages\com.ajcampbell.lbeast\package.json' -Raw; $content = $content -replace '(\"version\":\s*\")([^\"]+)(\")', '$1%VERSION%$3'; Set-Content 'Packages\com.ajcampbell.lbeast\package.json' -Value $content -NoNewline"
if %ERRORLEVEL% NEQ 0 (
